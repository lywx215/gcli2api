...
def _ensure_empty_tool_schema_for_claude(tools: Any, model_name: str, mode: str = "antigravity") -> Any:
    ...
    if is_claude:
        ...
        for tool in tools:
            ...
            # Antigravity converts declarations back to Anthropic custom tools.
            # parametersJsonSchema is required for input_schema to survive that conversion.
            normalized_tools.append({
                "functionDeclarations": [{
                    "name": name,
                    "description": description,
                    "parametersJsonSchema": _clean_parameters_json_schema(schema),
                }]
            })
...
def prepare_image_generation_request(
    ...
    1. 客户端原生 generationConfig.imageConfig
    ...
    if client_image_config:
        image_config = client_image_config.copy()
...
def _normalize_antigravity_request(
    ...
    if "gemini" in model.lower():
        ...
        model = map_antigravity_gemini_model(
