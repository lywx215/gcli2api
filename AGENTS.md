...
- 当前管理系统功能统一在`dev8`开发；`dev8`已以MGMT-008完成后的
  `origin/dev7@96736b1ea7e222c1a6a5f8e83ab95e0d4e1e3462`为创建基线。功能只进入
  `dev8`或从其派生的短分支；未经单独Review和明确授权不得自动合并回`dev7`、`dev6`、
  `dev5`或`master`。
